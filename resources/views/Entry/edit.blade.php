<x-layouts.app>
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            {{-- <hr class="my-5" /> --}}
            <form action="{{ route('entries.update', $entry) }}" method="POST" class="row g-3 needs-validation"
                ...
                <div class="col-md-4">
                    ...
                    <input name="family_name" type="text"
                        ...
                        value="{{ old('family_name', $entry->family_name) }}">
                    @error('family_name')
                        <div>
                ...
                <div class="col-md-4">
                    ...
                    <input name="diwan_num" type="number"
                        ...
                        value="{{ old('diwan_num', $entry->diwan_num) }}">
                    @error('diwan_num')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-4">
                    ...
                    <input name="smartCard_num" type="number"
                        ...
                        value="{{ old('smartCard_num', $entry->smartCard_num) }}">
                    @error('smartCard_num')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-4">
                    ...
                    <div class="input-group has-validation">
                        ...
                        <input name="phone_num" type="text"
                            ...
                            value="{{ old('phone_num', $entry->phone_num) }}" placeholder="0944444458"
                ...
                <div class="col-md-4">
                    ...
                    <input name="registration_num" type="number"
                        ...
                        value="{{ old('registration_num', $entry->registration_num) }}">
                ...
                <div class="col-md-4">
                    ...
                    <input name="family_num" type="number"
                        ...
                        value="{{ old('family_num', $entry->family_num) }}">
                    @error('family_num')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input name="renewal_date" type="date" class="form-control"
                        value="{{ old('renewal_date', $entry->renewal_date) }}">
                    @error('renewal_date')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-4">
                    ...
                    <input name="finshed_date" type="date" class="form-control"
                        value="{{ old('finshed_date', $entry->finshed_date) }}">
                    @error('finshed_date')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    <input name="address" type="text"
                        ...
                        value="{{ old('address', $entry->address) }}" placeholder="city">
                    @error('address')
                        <div class="alert alert-danger"> {{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input name="salary_charity" type="number" class="form-control"
                        value="{{ old('salary_charity', $entry->salary_charity) }}">
