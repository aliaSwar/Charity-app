<x-layouts.app>
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> تعديل بيانات
                الكفيل{{ $sponsor->user->name }}</h4>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input name="name" type="text"
                                                ...
                                                value="{{ old('name', $sponsor->user->name) }}" />
                                            @error('name')
                                                <div>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input name="email" type="text" id="basic-icon-default-email"
                                                ...
                                                value="{{ old('email', $sponsor->user->email) }}"
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input name="phone" type="text" id="basic-icon-default-phone"
                                                ...
                                                value="{{ old('phone', $sponsor->user->phone) }}"
