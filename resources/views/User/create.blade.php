<x-layouts.app>
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y ">
            ...
            <div class="card mb-3" {{-- style="max-width: 800px;" id="bb" --}}>
                <div class="row g-0">
                    <div class="d-flex flex-row">
                        <img src="{{ asset('assets/img/image/t.jpg') }}" class="img-fluid d-grid gap-2 col-lg-4 mx-auto"
                            alt="..." id="perr">
                    </div>
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                ...
                                <label for="validationCustom02" class="form-label "> اسم
                                    الموظف </label>
                                <input type="number" class="form-control form-control-lg is-valid"
                            ...
                            <li class="list-group-item">
                                <form>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <label for="validationCustom02" class="form-label" id="per"> : الصلاحيات
                                            للموظف </label>
