                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="" style="text-decoration: none;" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">انعاش الفقير</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">كنْ صاحبَ الخَيرِ تنويه وتفعلُهُ 👋</h4>
