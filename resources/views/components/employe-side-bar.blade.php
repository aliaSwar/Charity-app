<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item">
                            ...
                            <ul class="menu-sub">
                                ...
                                <li>
                                    <a href="tables-basic.html" class="menu-link">
                                        <div> قسم الإدراج الطبي</div>
                                    </a>
                                </li>
                                <li>
                                    <a href="tables-basic.html" class="menu-link">
                                        <div> قسم الكفالات</div>
                                    </a>
                                </li>
                        </li>
                    </ul>
            ...
            <li class="menu-item">
                <a href="show-per.html" class="menu-link ">
                    <i class="menu-icon tf-icons   bx bx-slider-alt"></i>

                    <div data-i18n="Account Settings"> الصلاحيات</div>
                </a>


            <li class="menu-item">
                <a href="show-roole.html" class="menu-link ">
                    <i class="menu-icon tf-icons   bx bx-task"></i>
                    <div data-i18n="Account Settings"> الوظائف</div>
                </a>
            </li>
